---
title: "Báo Cáo Hiệu Suất Vận Hành Đa Kênh Pancake (Ngày 11/09/2026)"
date: 2026-09-11
...
tags:
  ...
  - marketing-report
  - omnichannel
summary: "Báo cáo hiệu suất vận hành Pancake ngày 11/09/2026 (Thứ Sáu) trên 10 kênh tương tác NERCI & H&H Nutrition: Thiết lập kỷ lục lịch sử 82 SĐT thu được, tiếp cận 339 khách hàng mới trên 926 điểm chạm (460 inboxes, 466 comments); NERCI Academy bùng nổ 50 SĐT khóa học K20."
sources: []
source_count: 0
---
...
<div style="background: linear-gradient(135deg, #0f766e 0%, #047857 50%, #064e3b 100%); padding: 28px 32px; border-radius: 16px; color: white; margin-bottom: 24px; box-shadow: 0 10px 25px rgba(6, 78, 59, 0.25);">
  ...
  <div style="margin-top: 16px; padding-top: 14px; border-top: 1px solid rgba(255,255,255,0.2); display: flex; flex-wrap: wrap; gap: 20px; font-size: 12px;">
    <span>📅 <strong>Ngày Báo Cáo:</strong> 11/09/2026 (00:00 - 23:59 GMT+7 · Thứ Sáu)</span>
    <span>👤 <strong>Người Báo Cáo:</strong> Đại Dương (Performance & Operations)</span>
    <span>💬 <strong>Tổng Khách Mới:</strong> 339</span>
    <span>📞 <strong>SĐT Thu Được:</strong> 82</span>
    <span>📈 <strong>Tỷ Lệ Thu SĐT (CR):</strong> 8.86%</span>
  </div>
</div>
...
```mermaid
xychart-beta
    title "Xu Hướng Tương Tác Tin Nhắn & SĐT Thu Thập (7 Ngày)"
    x-axis ["09-05", "09-06", "09-07", "09-08", "09-09", "09-10", "09-11"]
    y-axis "Số lượng" 0 --> 568
    bar [447, 402, 488, 343, 413, 430, 460]
    line [21, 30, 29, 36, 43, 60, 82]
```
...
```mermaid
xychart-beta
    title "Phân Bổ Lưu Lượng Tương Tác Tin Nhắn 24 Giờ (Ngày 11/09/2026)"
    x-axis ["00h", "01h", "02h", "03h", "04h", "05h", "06h", "07h", "08h", "09h", "10h", "11h", "12h", "13h", "14h", "15h", "16h", "17h", "18h", "19h", "20h", "21h", "22h", "23h"]
    y-axis "Tin nhắn" 0 --> 72
    bar [5, 0, 0, 1, 4, 6, 5, 32, 34, 23, 34, 30, 23, 19, 24, 20, 57, 14, 24, 33, 33, 18, 18, 3]
    line [2, 0, 0, 0, 3, 2, 2, 1, 6, 2, 4, 4, 2, 5, 4, 5, 5, 2, 5, 3, 9, 9, 6, 1]
```
